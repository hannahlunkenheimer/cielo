...
d_explicitconcepts$gender <- recode(d_explicitconcepts$gender, 'Male' = 1, 'Female'=2)
d_explicitconcepts$control...6 <- recode(d_explicitconcepts$control...6, 'Really Disagree' = 1, 'Disagree'=2, 'Kind of Disagree' = 3, 'Kind of Agree' = 4, 'Agree' = 5, 'Really Agree' = 6)
...
multi_mo <- multinom(explicit_concepts2 ~ religiosity + gender + age, data = d_explicit,model=TRUE)
summary(multi_mo)
...
relig <- plot(Effect("religiosity",multi_mo),multiline=T)

relig

plot(Effect("gender",multi_mo),multiline=T)
