...
sppplot<- ggplot(data = sppfigdata, aes(x=cat, fill=question)) + 
  geom_bar(position = "dodge") +
    ...
    scale_fill_brewer(palette = "Paired", labels=c("goddo"= "What does God do?", "earth" = "What kinds of things does God \nmake happen on earth?", "ownlife"= "Has God ever made something \nhappen in your own life?", "peopleslives" = "What kinds of things does God \nmake happen in people's lives?")) +
