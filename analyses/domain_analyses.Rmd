...
domainclusters <- ggplot(data = d_domain_long2, mapping = aes(x = variable, y = value, color = variable)) + 
  ...
  labs(title = "Intervention Domain Mean Scores", x = "Domain", y = "Intervention scores") + 
...
domainclusters
ggsave("../figs/domainclusters.png", domainclusters, width = 6, height = 6, dpi = 300)
...
g_allinter <- ggplot(d_domain, aes(x = age, y = alldomains)) + 
 ...
 # geom_jitter(aes(age, psych, color = "Psych"), width = .2, height = .2, alpha=.3) +
  ...
  theme_minimal() +
  labs(title="Children's responses to intervention frequency questions by domain cluster", x = "Age", y = "Domain score", color = "Domain") +
...
g_allinter
ggsave("g_allinter.png", g_allinter, width = 4, height = 4, dpi = 300)
