...
packages <- c("moonBook", "dplyr", "readr", "ggplot2", "sjPlot", "apaTables", "lme4", "car", "DHARMa", "janitor", "reshape2", "ggsignif", "stats", "stringr", "ggpubr", "tidyr", "lsmeans", "daggity", "ggdag") 
...
# plot crosstab
relig_map <- ggplot(cross_tab_tidy_filtered, aes(x = Var1, y = Var2, size = Freq)) +
  geom_point(color = "#33a12c", shape = 21, fill = "#33a12c") +  # Fill points with green color
...
```{r correlatioin parent beliefs and fam religiosity}
...
ggsave("../figs/domainclusters.png", domain_clusters, width = 6, height = 4, dpi = 300)
