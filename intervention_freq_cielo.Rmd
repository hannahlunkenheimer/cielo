...
# recoding gender here to use in our reg
d_intervention2$gender <- dplyr::recode(d_intervention2$gender, 'Male' = 1, 'Female'=2)
...
reg3t <- lm(totalinter ~ age + gender + control + religiosity + age*gender + age*control + gender*control + age*religiosity + gender*religiosity + control*religiosity, data = d_intervention)

reg4t <- lm(totalinter ~ age + gender + control + religiosity + age*control + gender*control, data = d_intervention)
