...
g_allinter <- ggplot(d_intervention2, aes(age,totalinter)) + 
  ...
  geom_smooth(aes(age,environment), color = "#fdbf6f", method = "glm", se = FALSE) +
  geom_jitter(aes(age, people), color = "#e2251d", width = .2, height = .2, alpha=.4) +
  geom_smooth(aes(age,people), color = "#e2251d", method = "glm", se = FALSE) + 
  geom_jitter(aes(age, totalinter), color = "#fc9c9c", width = .2, height = .2, alpha=.4) +
  geom_smooth(aes(age,totalinter), color = "#fc9c9c", method = "glm", se = FALSE) +
  theme_minimal() +
