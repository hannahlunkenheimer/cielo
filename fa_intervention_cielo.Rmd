...
---
# Effects of IVs on intervention frequency task
...
3. Linear regression models with age and gender for environment, people, and total intervention scores
...
p_irc <- ggplot(data = d_intervention_reshaped, aes(x = variable, y = age, fill = value)) +
      ...
      geom_text(aes(label = value), position = position_stack(vjust = 0.5), color="black", size=3) +
      theme_classic() +
