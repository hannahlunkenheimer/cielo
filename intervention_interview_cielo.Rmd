...
d_interview$gender <- recode(d_interview$gender, 'Male' = 1, 'Female'=2)
d_interview$control...6 <- recode(d_interview$control...6, 'Really Disagree' = 1, 'Disagree'=2, 'Kind of Disagree' = 3, 'Kind of Agree' = 4, 'Agree' = 5, 'Really Agree' = 6)
d_interview$relig_attendserv <- recode(d_interview$relig_attendserv, 'Never' = 1, 'Less than once a year'=2, 'A few times a year' = 3, 'A few times a month' = 4, 'A few times a week' = 5, 'Daily' = 6)
d_interview$relig_tradition <- recode(d_interview$relig_tradition, 'Not at all important' = 1, 'Minimally important'=2, 'Moderately important' = 3, 'Very important' = 4)
d_interview$rgod_happen_earth <- recode(d_interview$rgod_happen_earth, 'No' = 1, 'Sometimes'=2, 'Yes' = 3, 'IDK' = 4)
d_interview$rgod_happen_ever <- recode(d_interview$rgod_happen_ever, 'No' = 1, 'Sometimes'=2, 'Yes' = 3, 'IDK' = 4)
d_interview$rgod_happen_lives <- recode(d_interview$rgod_happen_lives, 'No' = 1, 'Sometimes'=2, 'Yes' = 3, 'IDK' = 4)
d_interview$rpers_happen <- recode(d_interview$rpers_happen, 'No' = 1, 'Sometimes'=2, 'Yes' = 3, 'IDK' = 4)
...
anova(null_model, reg1, reg2, reg3, reg4, reg5, reg6)
tab_model(null_model, reg1, reg2, reg3, reg4, reg5, reg6)
AIC(null_model, reg1, reg2, reg3, reg4, reg5, reg6)
